...
• `.م24` ➪ كتم الخاصة (`.كتم خاص` ، `.فك كتم خاص`)
• `.م25` ➪ حفظ الميديا يدوي (`.حفظ`)
...
# ----------------------------------------------------
# 8. بقية الأوامر بالعامية (من .م1 إلى .م30)
# ----------------------------------------------------
